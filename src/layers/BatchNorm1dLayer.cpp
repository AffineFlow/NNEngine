...
BatchNorm1dLayer::BatchNorm1dLayer(int num_features, float eps, float momentum)
    : gamma_(affineengine::Shape{1, num_features}, true),
      beta_(affineengine::Shape{1, num_features}, true),
      running_mean_(affineengine::Shape{1, num_features}, false),
      running_var_(affineengine::Shape{1, num_features}, false),
      momentum_(momentum),
      eps_(eps) {
...
autograd::Tensor* BatchNorm1dLayer::forward(autograd::Tensor* input) {
  ...
  auto* op = tape->allocate_op<affineengine::autograd::ops::BatchNorm1dOp>(
